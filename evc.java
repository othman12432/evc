            ...
            if (pass==user_pass){
                ...
                switch (dooro){//bilowga dorashoyinka Guud
                    case 1://1.Itus Haraaga
                        System.out.println("{-EvcPlus-} Haraagagu waa $"+balance);
                        break;
                    case 2:
                        ...
                        switch (Ku_hadal){// Bilowga  doorashoyinka 2.Kaarka hadalka
                            case 1://1.Ku Shubo Airtime
                                ...
                                if (yeelid==1 ) {
                                    if (balance > lacag) {
                                        System.out.println("waxa ku shubay $" + lacag + "\n haraagagu waa:" + (balance - lacag));
                                    }
                                ...
                                else System.out.print("Mahadsanid! ");
                                break;
                            case 2://2.ugu Shub Airtime
                                System.out.print("Fadlan geli mobile kaaga");
                                int mobile= input.nextInt();
                                System.out.print("Fadlan geli lacagta");
                                int lacag2=input.nextInt();
                                System.out.print("\n ma hubta inaad $"+lacag2+" ugu shubtid" +mobile+"? \n1: Haa\n2: Maya");
                                int shubasho=input.nextInt();
                                if (shubasho==1){
                                    if (balance>lacag2){
                                        System.out.print("waxad ku gulesatay $"+lacag2+"ugu shubtay "+mobile+"\n Hsraagaagu waa"+(balance-lacag2));
                                    }

                                    else if (balance<lacag2){
                                        System.out.print("Haraaga xisaabtaadu kuguma filna, mobile No:"+mobile);
                                    }
                                }else System.out.print("Mahadsanid!");
                                break;
                                    ...
                                    case 1://1.Isbuucle (Weekly)
                                        ...
                                        if (shubasho1==1){
                                            ...
                                            if (mifi==1){
                                                ...
                                                else System.out.println("Haraaga xisaabtafu kuguma filna mobile No:"+Mifi);
                                    ...
                                    case 3://3.Bille(Mifi)
                                        ...
                                        if (shubasho3==2){
                                            ...
                                            if (mifi==1){
                                                ...
                                                else System.out.println("Haraaga xisaabtafu ku guma filna mobile No:"+Mifi);
                    ...
                    case 6://SALAAM BANK
                        ...
                        switch (Salam_Bank){// bolowga doorashoyinka bangiga
                            case 1://1.Itus Haraaga slam bank
                                ...
                                int Accoutn=300050005;
                                System.out.println("Koontadaada Bangiga:  "+Accoutn+ "\nHaraageedu waa:  "+balance);
                                break;
                                ...
                                switch (Tixda_Bank){//(4.ka wareeji EVCPlus )Tixda xisaabta Bank Salam_Bank
                                    ...
                                    case 2://Darasalaam Bank
                                        ...
                                        if (num1_user == Numkaga) {
                                            ...
                                            }else System.out.println("Waad Ku guuleesatay inaad iska joojiso adeegaan");
                            ...
                            case 1://1. Gudaha
                                ...
                                switch (shirkada){//Tixaha Gudaha
                                    case 1:// e-kaafi
                                        ...
                                        if (hubitel == 1) {
                                            System.out.println("Waxaad $" + (balance- geli_lacagta) + "  ugu shubtay Number ka " + (teleefonka_qaataha));
                                        }
                                        else
